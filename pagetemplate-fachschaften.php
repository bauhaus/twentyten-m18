<?php
/**
 * Template Name: Fachschaften Posts + Sidebar
 *
...
<h1 style="clear: none; float: left;" class="page-title"><span>Alle Nachrichten der Fachschaften</span></h1>
<?php 
...
<?php
 ...
 get_template_part( 'loop', 'index' );?>
		...
		<div id="primary" class="widget-area" role="complementary">
			...
			<?php dynamic_sidebar('fachschaften-widget-area'); ?>
			<?php get_footer(); ?>
			</ul>
