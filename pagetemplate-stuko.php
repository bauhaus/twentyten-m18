<?php
/**
 * Template Name: Stuko Posts + Sidebar
 *
...
<h1 style="clear: none; float: left;" class="page-title"><span>Alle Nachrichten des StuKo</span></h1>
<?php 
...
<?php
 ...
 get_template_part( 'loop', 'index' );?>
		...
		<div id="primary" class="widget-area" role="complementary">
			...
			<?php dynamic_sidebar('stuko-widget-area'); ?>
			<?php get_footer(); ?>
			</ul>
