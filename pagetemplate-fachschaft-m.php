<?php
/**
 * Template Name: FS M Posts + Sidebar
 *
...
<h1 style="clear: none; float: left;" class="page-title"><span>Alle Nachrichten der Fachschaft M</span></h1>
<?php 
...
<?php
 ...
 get_template_part( 'loop', 'index' );?>
		...
		<div id="primary" class="widget-area" role="complementary">
			...
			<?php dynamic_sidebar('fachschaft-m-widget-area'); ?>
			<?php get_footer(); ?>
			</ul>
