<?php
/**
 * Template Name: FS A Posts + Sidebar
 *
...
<h1 style="clear: none; float: left;" class="page-title"><span>Alle Nachrichten der Fachschaft A</span></h1>
<?php 
...
<?php
 ...
 get_template_part( 'loop', 'index' );?>
		...
		<div id="primary" class="widget-area" role="complementary">
			...
			<?php dynamic_sidebar('fachschaft-a-widget-area'); ?>
			<?php get_footer(); ?>
			</ul>
